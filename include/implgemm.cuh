...
#pragma unroll
    for (int i = 0; i < 4; ++i)
    {
        ...
        {
            input_ldg_reg[i] = param.in[inOffset + inOffsetTmp];
        }
        else
        {
            input_ldg_reg[i] = 0.0;
